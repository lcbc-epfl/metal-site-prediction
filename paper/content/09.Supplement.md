...
![Distance distribution Metal1D](images/selectivity_metal1D_distances_violin.jpg){#fig:selectivity-distance-metal1d tag="S4"}

#### Metal3D


![MAD for Metal3D on all true positive predictions in the test set.](images/distances_violin.jpg){#fig:selectivity-distance-metal3d tag="S5"}
