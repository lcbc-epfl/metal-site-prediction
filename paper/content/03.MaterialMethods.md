...
$$
\text{Precision} =\frac{\text{ n correct metal sites}}{\text{n correct metal sites} + \text{n false positive clustered}}
$$

Recall was calculated as 
$$
\text{Recall} =\frac{\text{n correct metal sites}}{\text{n correct metal sites} + \text{n not found metal sites}}
$$
